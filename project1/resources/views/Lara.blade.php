            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @else         
                        <td class="text-warning font-weight-bold" data-toggle="tooltip" data-placement="bottom" title="{{$lara->time}}">Expired <button class="btn btn-outline-warning extendbutton btn-sm" type="button" id="extend{{$lara->id}}">+2h</button></td>
                        @endif
