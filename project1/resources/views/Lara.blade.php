                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-danger font-weight-bold">
                            ...
                            @endif
                            <span  class="tooltiptext" >Booked at: {{date("d.m.Y H:i", strtotime($lara->time->modify('+60 minutes')))}}</span>
                        </td>   
                        @else         
                        <td class="text-warning font-weight-bold ">Expired <button class="btn btn-outline-warning extendbutton btn-sm" type="button" id="extend{{$lara->id}}">+2h</button>
                            <span  class="tooltiptext" >Booked at: {{date("d.m.Y H:i", strtotime($lara->time->modify('+60 minutes')))}}</span></td>
                        @endif
