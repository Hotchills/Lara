            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @else         
                        <td class="text-warning font-weight-bold tooltip"> Expired
                            <button class="btn btn-outline-warning extendbutton btn-sm" type="button" id="extend{{$lara->id}}">+2h</button> 
                            <span class="tooltiptext">Booked at: {{date("d.m.Y H:i", strtotime($lara->time->modify('+120 minutes')))}}</span></td>
                        @endif
