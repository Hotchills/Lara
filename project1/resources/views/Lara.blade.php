            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-danger font-weight-bold" data-toggle="tooltip" data-placement="bottom" title="Booked at: {{date("d.m.Y H:i", strtotime($lara->time->modify('+120 minutes')))}}">
                        ...
                        @else         
                        <td class="text-warning font-weight-bold" data-toggle="tooltip" data-placement="bottom" title="Booked at: {{date("d.m.Y H:i", strtotime($lara->time->modify('+120 minutes')))}}">Expired <button class="btn btn-outline-warning extendbutton btn-sm" type="button" id="extend{{$lara->id}}">+2h</button></td>
                        @endif
